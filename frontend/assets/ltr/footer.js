                    ...
                    <div class="footer-widget contact">
                        ...
                        <ul class="footer-contact">
                            <li>
                                ...
                                <p>
                                    <span>harshpamnani0303@gmail.com</span>
                                    <span>nikhilsadwani623@gmail.com</span>
                                </p>
                            </li>
                            <li>
                                <i class="icofont-ui-touch-phone"></i>
                                <p>
                                    <span>+91 82336-99523</span>
                                    <span>+91 77423-19827</span>
                                </p>
                            </li>
                            <li>
                                <i class="icofont-location-pin"></i>
                                <p>2-T-19 Patel Nagar 311001 Bhilwara (Rajasthan)</p>
                            </li>
                        </ul>
                    </div>
                </div>
